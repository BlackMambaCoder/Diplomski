...
////import org.eclipse.paho.client.mqttv3.MqttDefaultFilePersistance;
...
//    public static final String INFO_TAG = "MqttServiceINFO"; // Debug TAG
//
//    private static final String MQTT_THREAD_NAME = "MqttService[" + DEBUG_TAG + "]"; // Handler Thread ID
//
//    private static final String MQTT_BROKER = "192.168.0.108"; // Broker URL or IP Address
...
//
//    private static final String MQTT_TOPIC_HOME_ROOM_TEMPERATURE = "home/room/temperature";
//
...
//        Log.w(INFO_TAG, "Synchronized start");
//        if(mStarted) {
...
//        Log.w(INFO_TAG, "Synchronized stop");
//        if(!mStarted) {
...
//
//                    mClient.subscribe(MQTT_TOPIC_HOME_ROOM_TEMPERATURE, 0);
//
